...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="menu_nav">
        <ul>
          <li class="active"><a href="O_Main.jsp"><button class="b">Hi <%=application.getAttribute("doname")%> !!</button></a></li>
          <li><a href="O_Login.jsp"><button>Logout</button></a></li>
        </ul>
      </div>
      <div class="logo">
        <h1 class="style3 style5">DSAS </h1>
      </div>
