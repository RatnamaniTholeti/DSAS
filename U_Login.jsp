    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <img src="images/ulogin.jpg" width="126" height="123" /></p>

          <div class="style2"></div>
          <form action="U_Authentication.jsp" method="post" id="leavereply">
            <label for="name"> <span class="style4"><br />
            Name (required) <br> </span></label>
            <span class="style4">
            <input name="userid" type="text" class="box" id="name" value="" placeholder="Enter the name" required />
            <label for="email"><br />
            <br />
            Password (required) <br></label>
            </span>
            <strong>
            <label for="email"></label>
            </strong>
            <label for="email">&nbsp; </label>
            <input type="password" id="pass" name="pass" class="box" placeholder="Enter the Password" required />
            <p>&nbsp;</p>
            <p>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
