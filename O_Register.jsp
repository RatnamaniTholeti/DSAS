    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <img src="images/register.png" width="126" height="124" /></p>
          <div class="style2">
            <form action="O_RegisterAuthentication.jsp" method="post" id="" enctype="multipart/form-data">
              ...
              <p class="style4">
                <input id="name" name="userid" class="text box" />
              </p>
              <span class="style4">
              ...
              <p class="style4">
                <input type="password" id="password" name="pass" class="text box" />
              </p>
              <br><p class="style4">
                <label for="email">Email Address (required)<br />
                </label><br>
                <br><input id="email" name="email" class="text box" />
              </p>
              <span class="style4">
              ...
              <p class="style4">
                <input id="mobile" name="mobile" class="text box" />
              </p>
              <span class="style4">
              ...
              <p class="style4">
                <input id="dob" name="dob" class="text box" />
              </p>
              <span class="style4">
              ...
              <p class="style4">
                <input id="pincode" name="pincode" class="text box" />
              </p>
              <span class="style4">
              ...
              <p class="style4">
                <input id="loc" name="location" class="text box" />
              </p>
              <span class="style4">
              ...
              <p>
                <input type="file" id="pic" name="pic" class="tex box" />
              </p>
              <p>
